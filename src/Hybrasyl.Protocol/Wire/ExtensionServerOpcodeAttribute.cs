...
/// <summary>
///     Marks a native server-to-client extension packet with its <c>u16</c> opcode and the
...
public sealed class ExtensionServerOpcodeAttribute(ushort opcode, Dialect since) : Attribute
{
